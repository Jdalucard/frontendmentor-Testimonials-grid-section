...
import './styles.css'
import image from '../assets/images/image-daniel.jpg'
import image2 from '../assets/images/image-jonathan.jpg'
import image3 from '../assets/images/image-kira.jpg'
import image4 from '../assets/images/image-jeanette.jpg'
import image5 from '../assets/images/image-patrick.jpg'

const Testimonials = () => {
  return (
    <>
      <main className="container_master">
        <header className="container_testimony">
          {/* testimonio 1 */}

          <span>
            <div className="container_card">
              <div className="container_image">
                <img src={image} alt="person1" />
                <div className="name_card">
                  <h3 className="name">Daniel Cliford</h3>
                  <p> Verfifed Graduate</p>
                </div>
              </div>
          ...
          <span>
            <div className="container_card">
              <div className="container_image">
                <img src={image3} alt="person1" />
                <div className="name_card color-card">
                  <h3 className="name">Kira Whittle</h3>
                  <p> Verfifed Graduate</p>
                </div>
              </div>
              <div className="body_card color_body">
